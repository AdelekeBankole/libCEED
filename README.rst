...
in the Julia package manager. For more information on the Julia interface, see
the `LibCEED.jl documentation <http://ceed.exascaleproject.org/libCEED-julia-docs/dev/>`_.
