...
PetscErrorCode SetupLibceedBDDC(DM dm_Pi, CeedData data_fine,
  ...
  ierr = CreateRestrictionFromPlex(ceed, dm_Pi, P_Pi, topo_dim, 0, 0, 0,
                                   &elem_restr_Pi);
  CHKERRQ(ierr);
  ...
  CeedVectorGetArray(mask_r_ceed, CEED_MEM_HOST, &mask_r_array);
  CeedVectorGetArray(mask_Gamma_ceed, CEED_MEM_HOST, &mask_Gamma_array);
  CeedVectorGetArray(mask_I_ceed, CEED_MEM_HOST, &mask_I_array);
